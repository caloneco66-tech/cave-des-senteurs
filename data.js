...
const PRODUCTS = [
  ...
  },
  {
    ...
    prix: 45000,
    devise: "FCFA",
    description: "Imagination de Louis Vuitton est une fragrance fraiche et agrumee pour homme. Un melange enivrant de the, cedrat et bergamote, rehausse de neroli et d'ambroxan. Longevite 7h, sillage fort.",
  ...
  },
  {
    ...
    prix: 52000,
    devise: "FCFA",
    description: "Good Girl Gone Bad de By Kilian est une fragrance florale et fruitee pour femme. Un bouquet envoûtant d'osmanthus, tuberose et jasmin, avec une touche d'ambre. Sensuelle et mysterieuse. Longevite 7h, sillage fort.",
    ...
    volume: "50 ml",
    nouveaute: true,
    images: ["img/good-girl-gone-bad.jpg"],
    emoji: "&#127801;"
  },
  {
    id: 14,
    ...
    prix: 45000,
    devise: "FCFA",
    description: "Tobacco Honey de Guerlain est une fragrance orientale gourmande pour homme et femme. Un accord envoûtant de miel, tabac et vanille, rehausse de feve de tonka et d'oud. Chaleureux et enveloppant. Longevite 8h, sillage fort.",
    ...
    volume: "200 ml",
    nouveaute: true,
    images: ["img/tobacco-honey.jpg"],
    emoji: "&#127855;"
  },
  {
    id: 15,
    nom: "Bleu de Chanel L'Exclusif",
    marque: "Chanel",
    categorie: "parfums",
    prix: 39500,
    devise: "FCFA",
    description: "Bleu de Chanel L'Exclusif est une version exclusive et plus intense du celebre Bleu de Chanel. Un accord boise et ambre d'une rare elegance, avec des notes de ciste, bois de santal et ambre. Longevite 8h, sillage fort.",
    notes: { tete: "Ambre, Ciste", coeur: "Notes boisees", fond: "Bois de santal" },
    longevite: "8 heures",
    sillage: "Fort",
    genre: "Pour homme",
    volume: "100 ml",
    nouveaute: false,
    images: ["img/bleu-chanel-exclusif.jpg"],
    emoji: "&#128171;"
  },
  {
    id: 2,
