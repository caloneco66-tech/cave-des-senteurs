...
function createProductCard(produit) {
  return `
    <article class="product-card" data-categorie="${produit.categorie}" data-prix="${getPrixRange(produit)}">
      <a href="produit.html?id=${produit.id}" class="product-card__img-link" aria-label="Voir ${produit.nom}">
        <div class="product-card__img">
          ...
          ${produit.nouveaute ? '<span class="product-card__badge">Nouveau</span>' : ""}
        </div>
      </a>
      <div class="product-card__body">
        ...
        <div class="product-card__footer">
          <span class="product-card__prix">${produit.prix.toLocaleString()} ${produit.devise || 'FCFA'}</span>
          <a href="${getWhatsAppLink(produit)}" class="btn btn--whatsapp btn--sm" target="_blank" rel="noopener" aria-label="Commander ${produit.nom} via WhatsApp">
