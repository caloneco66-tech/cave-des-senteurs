      ...
      <div class="product-card__body">
        ...
        <div class="product-card__footer">
          ...
          <div style="display:flex;gap:var(--space-2);align-items:center;">
            <button class="btn btn--panier btn--sm" onclick="event.preventDefault();Panier.ajouter(${JSON.stringify({id:produit.id,nom:produit.nom,marque:produit.marque||'',prix:produit.prix,devise:produit.devise||'FCFA',images:produit.images,emoji:produit.emoji||'🛍️'}).replace(/"/g,"'").replace(/'/g,'&apos;')})" aria-label="Ajouter au panier">🛍️</button>
